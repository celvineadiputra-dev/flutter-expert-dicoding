...
@GenerateMocks([DatabaseMovieHelper])
void main() {
  late MockDatabaseMovieHelper mockDatabaseMovieHelper;

  setUp(() {
    mockDatabaseMovieHelper = MockDatabaseMovieHelper();
  });
  ...
  group("Movie", () {
    test("Insert Watchlist", () async {
      ...
      final result = await mockDatabaseMovieHelper.insertWatchlist(testMovieTable);
    ...
    test("Remove Watchlist", () async {
      ...
      final result = await mockDatabaseMovieHelper.removeWatchlist(testMovieTable);
